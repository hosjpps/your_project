...
const galleryItems: Record<string, { label: string; icon: string; image?: string }[]> = {
  windows: [
    { label: 'Окна в квартире', icon: 'home', image: '/pvh1.jpeg' },
    { label: 'Панорамное остекление', icon: 'maximize', image: '/pvh2.jpeg' },
    { label: 'Окна в коттедже', icon: 'building', image: '/pvh3.jpeg' },
    { label: 'Арочные окна', icon: 'circle', image: '/pvh4.jpeg' },
    { label: 'Окна с ламинацией', icon: 'palette', image: '/pvh5.jpeg' },
  ],
  doors: [
    { label: 'Дверь квартирная', icon: 'door-open', image: '/dver1.jpeg' },
    { label: 'Дверь с терморазрывом', icon: 'thermometer', image: '/dver2.jpeg' },
    { label: 'Дверь в дом', icon: 'home', image: '/dver3.jpeg' },
    { label: 'Техническая дверь', icon: 'lock', image: '/dver4.jpeg' },
    { label: 'Входная дверь', icon: 'shield', image: '/dver5.jpeg' },
  ],
  balconies: [
    { label: 'Тёплое остекление', icon: 'sun', image: '/balkon1.jpeg' },
    { label: 'Отделка балкона', icon: 'paintbrush', image: '/balkon2.jpeg' },
    { label: 'Балкон под ключ', icon: 'key', image: '/balkon3.jpeg' },
    { label: 'Лоджия', icon: 'panel-top', image: '/balkon4.jpeg' },
  ],
  gates: [
    { label: 'Секционные ворота', icon: 'warehouse', image: '/vorota1.jpeg' },
    { label: 'Откатные ворота', icon: 'move-horizontal', image: '/vorota2.jpeg' },
    { label: 'Распашные ворота', icon: 'door-open', image: '/vorota3.jpeg' },
    { label: 'Ворота с калиткой', icon: 'door-closed', image: '/vorota4.jpeg' },
    { label: 'Промышленные ворота', icon: 'factory', image: '/vorota5.jpeg' },
    { label: 'Роллетные ворота', icon: 'blinds', image: '/vorota6.jpeg' },
  ],
  blinds: [
    { label: 'Горизонтальные', icon: 'minus', image: '/jaluzi1.jpeg' },
    { label: 'Вертикальные', icon: 'grip-vertical', image: '/jaluzi2.jpeg' },
    { label: 'Рулонные шторы', icon: 'scroll', image: '/jaluzi3.jpeg' },
  ],
  frameless: [
    { label: 'Безрамное остекление', icon: 'sun', image: '/bezramnoe1.jpeg' },
    { label: 'Панорамный вид', icon: 'maximize', image: '/bezramnoe2.jpeg' },
  ],
  'soft-windows': [
    { label: 'Мягкие окна', icon: 'tent', image: '/myagkie-okna1.jpeg' },
    { label: 'Мягкие окна для веранды', icon: 'home', image: '/myagkie-okna2.jpeg' },
  ],
  aluminum: [
    { label: 'Витражное остекление', icon: 'grid-3x3', image: '/vitrazh.jpeg' },
    { label: 'Офисная перегородка', icon: 'columns-3', image: '/ofisnaya-peregorodka.jpeg' },
    { label: 'Входная группа', icon: 'door-open', image: '/vhodnaya-gruppa.jpeg' },
    { label: 'Фасадное остекление', icon: 'maximize', image: '/fasadnoe.jpeg' },
  ],
}
