...
const partners = [
  ...
  { name: 'KBE', description: 'Оконные профили', accent: 'group-hover:border-blue-400 group-hover:bg-blue-50' },
  { name: 'Veka', description: 'ПВХ-системы', accent: 'group-hover:border-sky-400 group-hover:bg-sky-50' },
