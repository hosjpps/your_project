      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8 pb-10 border-b border-white/10">
          ...
          <div>
            ...
            >
              <img src="/logo.png" alt="Свой Проект" width={1024} height={1024} className="h-44 w-44 object-contain -my-14" />
            </a>
        ...
        <div className="md:hidden pb-6 border-b border-white/10">
          <div className="flex items-center justify-between mb-5">
            ...
            >
              <img src="/logo.png" alt="Свой Проект" width={1024} height={1024} className="h-32 w-32 object-contain -my-10" />
            </a>
          </div>
